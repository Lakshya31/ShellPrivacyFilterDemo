...
class KerasModel():
    def __init__(self):
        ...
        self.X = pickle.load(open(os.path.join(os.path.expanduser(), "data", "Image Dataset", "features.pickle"), "rb"))
        self.y = pickle.load(open(os.path.join(os.path.expanduser(), "data", "Image Dataset", "labels.pickle"), "rb"))
    ...
    def save_model(self):
        self.model.save(os.path.join(os.path.expanduser(),"backend", "models", "keras_model"))
        with open(os.path.join(os.path.expanduser(),"backend", "models", "model_history"), 'wb') as file_pi:
    ...
    def load_model(self):
        self.model = load_model(os.path.join(os.path.expanduser(),"backend", "models","keras_model"))
        self.history = pickle.load(open(os.path.join(os.path.expanduser(),"backend", "models","model_history"), "rb"))
